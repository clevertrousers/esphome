...
void setup() {
  ...
  // esphome:
  //   name: ac-boysbed
  //   build_path: ac-boysbed
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("ac-boysbed", __DATE__ ", " __TIME__, false);
  // time:
  // text_sensor:
  // light:
  // climate:
  ...
  // wifi:
  //   ap:
  //     ssid: Boys Bedroom A/C F/B Hotspot
  //     password: TqsFC9fSbCuV
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: ac-boysbed.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("ac-boysbed.local");
  ...
  wifi_wifiap.set_ssid("Boys Bedroom A/C F/B Hotspot");
  wifi_wifiap.set_password("TqsFC9fSbCuV");
  ...
  // ota:
  //   password: 2bfcceaf431b201f623308c5e486f98b
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 8266
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("2bfcceaf431b201f623308c5e486f98b");
  ...
  // substitutions:
  //   name: ac-boysbed
  //   friendly_name: Boys Bedroom A/C
  // preferences:
  ...
  // text_sensor.version:
  //   platform: version
  //   name: ac-boysbed ESPHome Version
  ...
  version_versiontextsensor->set_name("ac-boysbed ESPHome Version");
  ...
  //   ssid:
  //     name: ac-boysbed SSID
  //     disabled_by_default: false
  //     id: wifi_info_ssidwifiinfo
  //   bssid:
  //     name: ac-boysbed BSSID
  //     disabled_by_default: false
  ...
  wifi_info_ipaddresswifiinfo->set_name("ac-boysbed IP");
  ...
  wifi_info_ssidwifiinfo->set_name("ac-boysbed SSID");
  ...
  wifi_info_bssidwifiinfo->set_name("ac-boysbed BSSID");
  ...
  uptime_uptimesensor->set_name("ac-boysbed Uptime");
  ...
  wifi_signal_wifisignalsensor->set_name("ac-boysbed WiFi Signal");
  ...
  mitsubishiheatpump->set_name("Boys Bedroom A/C");
  mitsubishiheatpump->set_disabled_by_default(false);
  // switch.restart:
  //   platform: restart
  //   name: Boys Bedroom A/C Restart
  //   disabled_by_default: false
  ...
  restart_restartswitch->set_name("Boys Bedroom A/C Restart");
