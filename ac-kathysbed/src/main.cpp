...
void setup() {
  ...
  // esphome:
  //   name: ac-kathysbed
  //   build_path: ac-kathysbed
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("ac-kathysbed", __DATE__ ", " __TIME__, false);
  // time:
  // text_sensor:
  // light:
  // climate:
  ...
  // wifi:
  //   ap:
  //     ssid: Kathys Bedroom A/C F/B Hotspot
  //     password: An383JTdXmnJ
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: ac-kathysbed.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("ac-kathysbed.local");
  ...
  wifi_wifiap.set_ssid("Kathys Bedroom A/C F/B Hotspot");
  wifi_wifiap.set_password("An383JTdXmnJ");
  ...
  // ota:
  //   password: c6c9d33b9a39b2d364430ba563fd6ca0
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 8266
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("c6c9d33b9a39b2d364430ba563fd6ca0");
  ...
  // substitutions:
  //   name: ac-kathysbed
  //   friendly_name: Kathys Bedroom A/C
  // preferences:
  ...
  // text_sensor.version:
  //   platform: version
  //   name: ac-kathysbed ESPHome Version
  ...
  version_versiontextsensor->set_name("ac-kathysbed ESPHome Version");
  ...
  //   platform: wifi_info
  //   ip_address:
  //     name: ac-kathysbed IP
  //     disabled_by_default: false
  //     id: wifi_info_ipaddresswifiinfo
  //   ssid:
  //     name: ac-kathysbed SSID
  //     disabled_by_default: false
  //     id: wifi_info_ssidwifiinfo
  //   bssid:
  //     name: ac-kathysbed BSSID
  //     disabled_by_default: false
  ...
  wifi_info_ipaddresswifiinfo->set_name("ac-kathysbed IP");
  ...
  wifi_info_ssidwifiinfo->set_name("ac-kathysbed SSID");
  ...
  wifi_info_bssidwifiinfo->set_name("ac-kathysbed BSSID");
  ...
  uptime_uptimesensor->set_name("ac-kathysbed Uptime");
  ...
  wifi_signal_wifisignalsensor->set_name("ac-kathysbed WiFi Signal");
  ...
  mitsubishiheatpump->set_name("Kathys Bedroom A/C");
  mitsubishiheatpump->set_disabled_by_default(false);
  // switch.restart:
  //   platform: restart
  //   name: Kathys Bedroom A/C Restart
  //   disabled_by_default: false
  ...
  restart_restartswitch->set_name("Kathys Bedroom A/C Restart");
