...
void setup() {
  ...
  // esphome:
  //   name: air-library
  //   build_path: air-library
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("air-library", __DATE__ ", " __TIME__, false);
  // time:
  // text_sensor:
  // light:
  // switch:
  ...
  // wifi:
  //   ap:
  //     ssid: Air Quality Library Hotspot
  //     password: V0cKJEQA5oAf
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: air-library.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("air-library.local");
  ...
  wifi_wifiap.set_ssid("Air Quality Library Hotspot");
  wifi_wifiap.set_password("V0cKJEQA5oAf");
  ...
  // ota:
  //   password: 6989bc8ebb63dbde23e0f335d1aa9695
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 8266
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("6989bc8ebb63dbde23e0f335d1aa9695");
  ...
  // substitutions:
  //   name: air-library
  //   friendly_name: Air Quality Library
  // preferences:
  ...
  // text_sensor.version:
  //   platform: version
  //   name: air-library ESPHome Version
  ...
  version_versiontextsensor->set_name("air-library ESPHome Version");
  ...
  //   ssid:
  //     name: air-library SSID
  //     disabled_by_default: false
  //     id: wifi_info_ssidwifiinfo
  //   bssid:
  //     name: air-library BSSID
  //     disabled_by_default: false
  ...
  wifi_info_ipaddresswifiinfo->set_name("air-library IP");
  ...
  wifi_info_ssidwifiinfo->set_name("air-library SSID");
  ...
  wifi_info_bssidwifiinfo->set_name("air-library BSSID");
  ...
  uptime_uptimesensor->set_name("air-library Uptime");
  ...
  wifi_signal_wifisignalsensor->set_name("air-library WiFi Signal");
  ...
  sensor_sensor->set_name("air-library 2.5\302\265m");
  ...
  // switch.restart:
  //   platform: restart
  //   name: Air Quality Library Restart
  //   disabled_by_default: false
  ...
  restart_restartswitch->set_name("Air Quality Library Restart");
