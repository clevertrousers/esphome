...
void setup() {
  ...
  // esphome:
  //   name: air-masterbed
  //   build_path: air-masterbed
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("air-masterbed", __DATE__ ", " __TIME__, false);
  // time:
  // text_sensor:
  // light:
  // switch:
  ...
  // wifi:
  //   ap:
  //     ssid: Air Quality Master Bed Hotspot
  //     password: NepPk5Ln6sL2
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: air-masterbed.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("air-masterbed.local");
  ...
  wifi_wifiap.set_ssid("Air Quality Master Bed Hotspot");
  wifi_wifiap.set_password("NepPk5Ln6sL2");
  ...
  // ota:
  //   password: c2de323510d8203d639d7b05b11366cd
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 8266
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("c2de323510d8203d639d7b05b11366cd");
  ...
  // substitutions:
  //   name: air-masterbed
  //   friendly_name: Air Quality Master Bed
  // preferences:
  ...
  // text_sensor.version:
  //   platform: version
  //   name: air-masterbed ESPHome Version
  ...
  version_versiontextsensor->set_name("air-masterbed ESPHome Version");
  ...
  //   platform: wifi_info
  //   ip_address:
  //     name: air-masterbed IP
  //     disabled_by_default: false
  //     id: wifi_info_ipaddresswifiinfo
  //   ssid:
  //     name: air-masterbed SSID
  //     disabled_by_default: false
  //     id: wifi_info_ssidwifiinfo
  //   bssid:
  //     name: air-masterbed BSSID
  //     disabled_by_default: false
  ...
  wifi_info_ipaddresswifiinfo->set_name("air-masterbed IP");
  ...
  wifi_info_ssidwifiinfo->set_name("air-masterbed SSID");
  ...
  wifi_info_bssidwifiinfo->set_name("air-masterbed BSSID");
  ...
  uptime_uptimesensor->set_name("air-masterbed Uptime");
  ...
  //   name: air-masterbed WiFi Signal
  //   update_interval: 5min
  //   disabled_by_default: false
  //   force_update: false
  ...
  wifi_signal_wifisignalsensor->set_name("air-masterbed WiFi Signal");
  ...
  sensor_sensor->set_name("air-masterbed 2.5\302\265m");
  ...
  // switch.restart:
  //   platform: restart
  //   name: Air Quality Master Bed Restart
  //   disabled_by_default: false
  ...
  restart_restartswitch->set_name("Air Quality Master Bed Restart");
