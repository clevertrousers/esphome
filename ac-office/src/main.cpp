...
void setup() {
  ...
  // esphome:
  //   name: ac-office
  //   build_path: ac-office
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("ac-office", __DATE__ ", " __TIME__, false);
  // time:
  // text_sensor:
  // light:
  // climate:
  ...
  // wifi:
  //   ap:
  //     ssid: Office A/C Fallback Hotspot
  //     password: v31vXt6oC4Sr
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: ac-office.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("ac-office.local");
  ...
  wifi_wifiap.set_ssid("Office A/C Fallback Hotspot");
  wifi_wifiap.set_password("v31vXt6oC4Sr");
  ...
  // ota:
  //   password: 58666ba87094e3287d710578be0f7c0a
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 8266
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("58666ba87094e3287d710578be0f7c0a");
  ...
  // text_sensor.version:
  //   platform: version
  //   name: ac-office ESPHome Version
  ...
  version_versiontextsensor->set_name("ac-office ESPHome Version");
  ...
  wifi_info_ipaddresswifiinfo->set_name("ac-office IP");
  ...
  wifi_info_ssidwifiinfo->set_name("ac-office SSID");
  ...
  wifi_info_bssidwifiinfo->set_name("ac-office BSSID");
  ...
  uptime_uptimesensor->set_name("ac-office Uptime");
  ...
  wifi_signal_wifisignalsensor->set_name("ac-office WiFi Signal");
  ...
  mitsubishiheatpump->set_name("Office A/C");
  mitsubishiheatpump->set_disabled_by_default(false);
  // switch.restart:
  //   platform: restart
  //   name: Office A/C Restart
  //   disabled_by_default: false
  ...
  restart_restartswitch->set_name("Office A/C Restart");
