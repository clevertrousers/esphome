...
void setup() {
  ...
  // esphome:
  //   name: air-office
  //   build_path: air-office
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("air-office", __DATE__ ", " __TIME__, false);
  // time:
  // text_sensor:
  // light:
  // switch:
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: air-office.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("air-office.local");
  ...
  wifi_wifiap.set_password("FYWuVwBGoZhB");
  ...
  // ota:
  //   password: 805578e54d2cb6ccdaa9500f58ef65e3
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 8266
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("805578e54d2cb6ccdaa9500f58ef65e3");
  ...
  // text_sensor.version:
  //   platform: version
  //   name: air-office ESPHome Version
  ...
  version_versiontextsensor->set_name("air-office ESPHome Version");
  ...
  //   ssid:
  //     name: air-office SSID
  //     disabled_by_default: false
  //     id: wifi_info_ssidwifiinfo
  //   bssid:
  //     name: air-office BSSID
  //     disabled_by_default: false
  ...
  wifi_info_ipaddresswifiinfo->set_name("air-office IP");
  ...
  wifi_info_ssidwifiinfo->set_name("air-office SSID");
  ...
  wifi_info_bssidwifiinfo->set_name("air-office BSSID");
  ...
  uptime_uptimesensor->set_name("air-office Uptime");
  ...
  airoffcwifi->set_name("air-office WiFi Signal");
  ...
  sensor_sensor->set_name("air-office 2.5\302\265m");
  ...
  // sensor.dallas:
  //   platform: dallas
  //   address: 0x3D3C01D6074ADF28
  //   name: air-office Temperature
  //   filters:
  //   - calibrate_linear:
  //     - from: 25.11
  //       to: 21.83
  ...
  dallas_dallastemperaturesensor->set_address(0x3D3C01D6074ADF28);
  ...
  dallas_dallastemperaturesensor->set_name("air-office Temperature");
  ...
  // switch.restart:
  //   platform: restart
  //   name: Air Quality Office Restart
  //   disabled_by_default: false
  ...
  restart_restartswitch->set_name("Air Quality Office Restart");
