...
wifi_signal::WiFiSignalSensor *airoffcwifi;
...
void setup() {
  ...
  // esphome:
  //   name: air-boysbed
  //   build_path: air-boysbed
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("air-boysbed", __DATE__ ", " __TIME__, false);
  // time:
  // text_sensor:
  // light:
  // switch:
  ...
  // wifi:
  //   ap:
  //     ssid: Air Quality Boys Bedroom
  //     password: UP2kl2gjBWVa
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: air-boysbed.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("air-boysbed.local");
  ...
  wifi_wifiap.set_ssid("Air Quality Boys Bedroom");
  wifi_wifiap.set_password("UP2kl2gjBWVa");
  ...
  // ota:
  //   password: 2557e9b526e908a6e8dc67d613f17b53
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 8266
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("2557e9b526e908a6e8dc67d613f17b53");
  ...
  // substitutions:
  //   name: air-boysbed
  //   friendly_name: Air Quality Boys Bedroom
  // preferences:
  ...
  // text_sensor.version:
  //   platform: version
  //   name: air-boysbed ESPHome Version
  ...
  version_versiontextsensor->set_name("air-boysbed ESPHome Version");
  ...
  //   ssid:
  //     name: air-boysbed SSID
  //     disabled_by_default: false
  //     id: wifi_info_ssidwifiinfo
  //   bssid:
  //     name: air-boysbed BSSID
  //     disabled_by_default: false
  ...
  wifi_info_ipaddresswifiinfo->set_name("air-boysbed IP");
  ...
  wifi_info_ssidwifiinfo->set_name("air-boysbed SSID");
  ...
  wifi_info_bssidwifiinfo->set_name("air-boysbed BSSID");
  ...
  uptime_uptimesensor->set_name("air-boysbed Uptime");
  ...
  airoffcwifi = new wifi_signal::WiFiSignalSensor();
  airoffcwifi->set_update_interval(300000);
  airoffcwifi->set_component_source("wifi_signal.sensor");
  App.register_component(airoffcwifi);
  App.register_sensor(airoffcwifi);
  airoffcwifi->set_name("air-boysbed WiFi Signal");
  airoffcwifi->set_disabled_by_default(false);
  airoffcwifi->set_device_class("signal_strength");
  airoffcwifi->set_state_class(sensor::STATE_CLASS_MEASUREMENT);
  airoffcwifi->set_unit_of_measurement("dBm");
  airoffcwifi->set_accuracy_decimals(0);
  airoffcwifi->set_force_update(false);
  // sensor.pm1006:
  //   platform: pm1006
  //   pm_2_5:
  //     name: air-boysbed 2.5µm
  //     disabled_by_default: false
  //     id: sensor_sensor
  //     force_update: false
  ...
  sensor_sensor->set_name("air-boysbed 2.5\302\265m");
  ...
  // sensor.dallas:
  //   platform: dallas
  //   address: 0x2F3C01D60785E928
  //   name: air-boysbed Temperature
  //   filters:
  //   - calibrate_linear:
  //     - from: 25.11
  //       to: 21.83
  ...
  dallas_dallastemperaturesensor->set_address(0x2F3C01D60785E928);
  ...
  dallas_dallastemperaturesensor->set_name("air-boysbed Temperature");
  ...
  // switch.restart:
  //   platform: restart
  //   name: Air Quality Boys Bedroom Restart
  //   disabled_by_default: false
  ...
  restart_restartswitch->set_name("Air Quality Boys Bedroom Restart");
