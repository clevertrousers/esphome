...
void setup() {
  ...
  // esphome:
  //   name: ac-library
  //   build_path: ac-library
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("ac-library", __DATE__ ", " __TIME__, false);
  // time:
  // text_sensor:
  // light:
  // climate:
  ...
  // wifi:
  //   ap:
  //     ssid: Library A/C F/B Hotspot
  //     password: 3BzZp4tTXuK9
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: ac-library.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("ac-library.local");
  ...
  wifi_wifiap.set_ssid("Library A/C F/B Hotspot");
  wifi_wifiap.set_password("3BzZp4tTXuK9");
  ...
  // ota:
  //   password: 44036e7baf843b56be650650d828aed2
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 8266
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("44036e7baf843b56be650650d828aed2");
  ...
  // text_sensor.version:
  //   platform: version
  //   name: ac-library ESPHome Version
  ...
  version_versiontextsensor->set_name("ac-library ESPHome Version");
  ...
  //   ssid:
  //     name: ac-library SSID
  //     disabled_by_default: false
  //     id: wifi_info_ssidwifiinfo
  //   bssid:
  //     name: ac-library BSSID
  //     disabled_by_default: false
  ...
  wifi_info_ipaddresswifiinfo->set_name("ac-library IP");
  ...
  wifi_info_ssidwifiinfo->set_name("ac-library SSID");
  ...
  wifi_info_bssidwifiinfo->set_name("ac-library BSSID");
  ...
  uptime_uptimesensor->set_name("ac-library Uptime");
  ...
  wifi_signal_wifisignalsensor->set_name("ac-library WiFi Signal");
  ...
  mitsubishiheatpump->set_name("Library A/C");
  mitsubishiheatpump->set_disabled_by_default(false);
  // switch.restart:
  //   platform: restart
  //   name: Library A/C Restart
  //   disabled_by_default: false
  ...
  restart_restartswitch->set_name("Library A/C Restart");
